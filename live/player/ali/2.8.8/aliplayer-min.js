...
!function n(a, s, l) {
    ...
    7: [function(e, t, i) {
        !function() {
            ...
            function s(o, e) {
                ...
                !s.notNeeded(o)) {
                    for (var i = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], r = 0, n = i.length; r < n; r++)
                        this[i[r]] = a(this[i[r]], this);
                    l && (o.addEventListener("mouseover", this.onMouse, !0),
            ...
            s.prototype.onTouchEnd = function(e) {
                ...
                "label" === (r = a.tagName.toLowerCase())) {
                    ...
                    return 100 < e.timeStamp - i || u && window.top !== window && "input" === r ? this.targetElement = null : (this.focus(a),
                    this.sendClick(a, e),
                    u && "select" === r || (this.targetElement = null,
                    e.preventDefault())),
                    !1;
                return !(!u || c || !(o = a.fastClickScrollParent) || o.fastClickLastScrollTop === o.scrollTop) || (this.needsClick(a) || (e.preventDefault(),
                this.sendClick(a, e)),
                !1)
            }
            ,
            ...
            s.prototype.destroy = function() {
                var e = this.layer;
                l && (e.removeEventListener("mouseover", this.onMouse, !0),
            ...
            "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
                return s
            }) : void 0 !== t && t.exports ? (t.exports = s.attach,
            t.exports.FastClick = s) : window.FastClick = s
        }()
    }
    , {}],
    8: [function(e, t, i) {
        ...
        e("../lib/util"))
          ...
          , p = r.extend({
            ...
            bindEvent: function() {
                ...
                u.domain ? -1 < u.domain.indexOf("localhost") && (t = "//" + u.domain + "/build/skins/default/img/dragcursor.png") : t = this._player && this._player._options && this._player._options.sdkDomain ? this._player._options.sdkDomain + "/de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png" : "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png",
                e.src = t,
    ...
    17: [function(n, e, t) {
        ...
        "aliplayer_lang")
          ...
          , d = function(e) {
            var t = c();
            return "aliplayer_lang_data_" + (e = e || "h5") + "_" + i.h5Version.replace(/\./g, "_") + "_" + t
        };
    ...
    29: [function(e, t, i) {
        ...
        var C = e("./attrlist")
          ...
          , c = /#EXT-X-STREAM-INF:([^\n\r]*)[\r\n]+([^\r\n]+)/g
          , u = /#EXT-X-MEDIA:(.*)/g
          , k = new RegExp([/#EXTINF:(\d*(?:\.\d+)?)(?:,(.*)\s+)?/.source, /|(?!#)(\S+)/.source, /|#EXT-X-BYTERANGE:*(.+)/.source, /|#EXT-X-PROGRAM-DATE-TIME:(.+)/.source, /|#.*/.source].join(""),"g")
                ...
                for (k.lastIndex = 0; null !== (o = k.exec(e)); ) {
                    ...
                    if (h) {
                        ...
                        case "KEY":
                            ...
                            break;
                        case "START":
                            var x = new C(g).decimalFloatingPoint("TIME-OFFSET");
    ...
    34: [function(e, f, t) {
        ...
        f.exports.handleOption = function(e, t) {
            ...
            return (void 0 === e.components || !e.components || _.isArray(e.components) && 0 == e.components.length) && "false" != e.components && (i.components = [y]),
            i
        }
    }
    , {
    ...
    37: [function(e, C, t) {
        ...
        function(e, t) {
            ...
            i.phone = !(i.tablet || i.ipod || !(n || u || c || y || g || S && e.match(/Android/) || S && e.match(/CriOS\/([\d.]+)/) || T && e.match(/Mobile/) || x && e.match(/Touch/))),
        ...
        var l = e("./vttparse")
          , r = {
            parse: function(e, t, i) {
                ...
                a.oncue = function(e) {
                    e.id = s(e.startTime) + s(e.endTime) + s(e.text),
        ...
        var r = e("../lib/oo")
          ...
          , a = r.extend({
            ...
            _onPlayerPlay: function() {
                ...
                this.firstPlay || 0 != this.pause_flag || this.player._seeking || (this.sessionId = v.guid()),
            ...
            _onPlayerPause: function() {
                this.buffer_flag && this.startTimePlay && (this.player._seeking || (this.pause_flag = 1,
            ...
            _onPlayerLoaded: function() {
                if (this.buffer_flag && this.startTimePlay && !(this.stucking || this.player._seeking || (this.stuckStartTime = (new Date).getTime(),
            ...
            _onPlayerUnderload: function() {
                if ((this.buffer_flag || !this.player._options || !this.player._options.autoplay) && this.stucking && !this.player._seeking) {
    ...
    46: [function(e, t, i) {
        ...
        t.exports.create = function(e, t) {
            ...
            var i = g.handleOption(e)
              , r = i.source
              , o = g.isAudio(r);
            o && (i.mediaType = "audio");
            var n, a = g.createWrapper(i);
            if (a.player)
                return a.player;
            if (o)
                n = new p(a,i);
            else if (!i.useFlashPrism && g.isFlv(r) && g.isSupportFlv())
                n = new f(a,i);
            else if (y.IS_MOBILE || !i.useFlashPrism && !g.isRTMP(r))
                if (i.vid && !i.source)
                    if (i.authInfo)
                        n = new c(a,i);
                    else {
                        if (!(i.playauth || i.accessKeyId && i.accessKeySecret)) {
                            var s = "vid=" + i.vid + " playauth='', playauth property is required by VOD(\u89c6\u9891\u70b9\u64ad) as new Aliplayer.";
                            throw new Error(s)
                        }
                        n = new d(a,i)
                    }
                else
                    g.isDash(r) && g.isSupportMSE() ? n = new _(a,i) : g.isHls(r) ? g.canPlayHls() ? n = g.isSupportHls() && (g.isUsedHlsPluginOnMobile() || g.isSafariUsedHlsPlugin(i.useHlsPluginForSafari)) ? new h(a,i) : new l(a,i) : g.isSupportHls() ? n = new h(a,i) : y.os.pc ? i.userH5Prism || i.useH5Prism || (n = new u(a,i)) : n = new l(a,i) : n = (y.os.pc,
                    new l(a,i));
            else
                n = new u(a,i);
            return n
    ...
    53: [function(e, t, i) {
        ...
        var o = e("../../event/eventtype")
          ...
          , l = [o.Private.EndStart, o.Private.SeekStart, o.Player.RequestFullScreen, o.Player.CancelFullScreen, o.Player.Error, o.Player.Ready, o.Private.Dispose, o.Private.Created];
    ...
    67: [function(e, t, i) {
        ...
        t.exports.handle = function(e) {
            ...
            o(),
            u.IS_IOS || (i._waitingDelayLoadingShowHandle = setTimeout(function() {
    ...
    68: [function(e, t, r) {
        ...
        e("../../lib/playerutil"))
          ...
          , P = n.extend({
            init: function(e, t) {
                ...
                this._duration = 0,
                this.__disposed = !1,
                void 0 === t.skinLayout && (t.skinLayout = h.defaultH5Layout),
                n.call(this, this, t),
                ...
                v.onAll(this),
                this._lifeCycleManager = new x(this),
                ...
                !this._liveshiftService || this._liveshiftService.validate()) {
                    ...
                    0 < this._options.progressMarkers.length && this.trigger(b.Private.ProgressMarkerLoaded, this._options.progressMarkers),
                    this._options.source && this._options._native && this._executeReadyCallback(),
                    this._options.autoplay || this._options.preload ? this.trigger(b.Private.H5_Loading_Show) : this.trigger(b.Private.Play_Btn_Show),
                    this._extraMultiSources(),
                    this._options.source)
                        if (this.trigger(b.Private.PREPARE, "custom"),
        ...
        P.prototype.switchUrl = function() {
            if (0 != this._urls.length) {
                ...
                _.set(d.SelectedStreamLevel, e.definition, 365),
                this.trigger(b.Private.QualityChange, y.get("Quality_Change_Fail_Switch_Text"));
                var t = this.getCurrentTime();
                this._vodRetryCount = 0,
        ...
        P.prototype.firstNewUrlloadByUrl = function(e, t) {
            ...
            this.initPlay(),
            this._options.autoplay && this.trigger(b.Private.Cover_Hide),
        ...
        P.prototype.loadByUrl = function(e, t, i, r) {
            ...
            this.initPlay(i),
            (this._options.autoplay || i) && this.trigger(b.Private.Cover_Hide),
        ...
        P.prototype.setVolume = function(e, t) {
            ...
            var i = y.get("Curent_Volume") + "<span>" + (100 * e).toFixed() + "%</span>";
        ...
        P.prototype.setPlayerSize = function(e, t) {
            this._el && (this._el.style.width = e,
        ...
        P.prototype.setCover = function(e) {
            ...
            this.trigger(b.Private.Cover_Show))
        }
        ,
        ...
        P.prototype._initPlayBehavior = function(e, t) {
            if (this._checkSupportVideoType())
                return !1;
            if (h.validateSource(t))
                return void 0 === e && (e = !1),
                this._created || (this._created = !0,
                this.trigger(b.Private.Created)),
                ...
                this._initLoad(t),
                (this._options.autoplay || this._options._autoplay) && this._startPlay()) : this.trigger(b.Private.Play_Btn_Show),
                !0;
            var i = {
                mediaId: this._options.vid ? this._options.vid : "",
            ...
            return i.display_msg = y.get("Error_Invalidate_Source"),
        ...
        P.prototype._initLoad = function(e) {
            this.getMetaData(),
            e && (this._isPreload() && !c.IS_MOBILE ? this.trigger(b.Private.H5_Loading_Show) : (this.trigger(b.Private.H5_Loading_Hide),
            this.trigger(b.Private.Play_Btn_Show)),
        ...
        P.prototype._checkSupportVideoType = function() {
            ...
            var e = this._options.source
              , t = "";
            if (0 < e.indexOf("m3u8") ? "" != this.tag.canPlayType("application/x-mpegURL") || h.isSupportHls() || (t = y.get("Error_Not_Support_M3U8_Text")) : 0 < e.indexOf("mp4") ? "" == this.tag.canPlayType("video/mp4") && (t = y.get("Error_Not_Support_MP4_Text")) : (h.isRTMP(e) || h.isFlv(e)) && c.IS_MOBILE && (t = y.get("Error_Not_Support_Format_On_Mobile")),
            t) {
                var i = {
                    mediaId: this._options.vid ? this._options.vid : "",
        ...
        P.prototype.setProgressMarkers = function(e) {
            e = e || [],
            this.trigger(b.Private.ProgressMarkerChanged, e)
        }
        ,
        ...
        P.prototype._overrideNativePlay = function() {
            ...
            this.tag.play = function() {
                if (!o._options.source) {
                    ...
                    return o._options.vid ? e.display_msg = y.get("Error_Vid_Empty_Source") : e.display_msg = y.get("Error_Empty_Source"),
                    void o.trigger(b.Player.Error, e)
                }
                ...
                void 0 !== t && t.then(function() {
                    ...
                    !o.tag || !o.tag.paused || o._isError || o._options._autoplay || o._switchedLevel || (o.trigger(b.Private.Play_Btn_Show),
                    o.trigger(b.Private.H5_Loading_Hide),
                    o.trigger(b.Player.AutoPlayPrevented),
                    o.trigger(b.Player.AutoPlay, !1),
                    o._options.cover && o.trigger(b.Private.Cover_Show))
                });
        ...
        P.prototype._extraMultiSources = function() {
            ...
            if (e && -1 < e.indexOf("{") && -1 < e.indexOf("}")) {
                ...
                if (0 < i.length) {
                    ...
                    this.trigger(b.Private.SourceLoaded, n)
                }
            }
        }
        ,
        ...
        P.prototype._executeReadyCallback = function() {
            try {
                this._options.autoplay || this._options.preload || (this.trigger(b.Private.H5_Loading_Hide),
                this.trigger(b.Private.Play_Btn_Show)),
        ...
        P.prototype._checkEnoughBufferedForWaiting = function(e) {
            this.getCurrentTime(),
            this._options.waitingBufferedTime;
    ...
    71: [function(e, t, i) {
        ...
        var l = function(e, t) {
          ...
          , d = function(e, t) {
            void 0 !== o[t] && (t != o.pause || e._status != o.error && e._status != o.ended) && (e._status = t)
        };
        t.exports = r
    }
    , {
    ...
    73: [function(e, t, i) {
        ...
        t.exports.adaptX5Play = function(e) {
            o.os.android && o.is_X5 && ("h5" == e._options.x5_type && (e.tag.setAttribute("x5-video-player-type", e._options.x5_type),
            ...
            e.on("requestFullScreen", function() {
                ...
                o.os.android && o.is_X5 && e._options.x5LandscapeAsFullScreen && (e.tag.setAttribute("x5-video-orientation", "landscape"),
            ...
            e.on("cancelFullScreen", function() {
                ...
                o.os.android && o.is_X5 && e._options.x5LandscapeAsFullScreen && (e.tag.setAttribute("x5-video-orientation", "portrait"),
                r(e, e._options.x5_fullscreen || "center" == e._options.x5_video_position),
            ...
            n.addClass(e.tag, "x5-full-screen")),
            "top" == e._options.x5_video_position && n.addClass(e.tag, "x5-top-left"),
                ...
                t.prototype.initPlay = function(e) {
                    ...
                    function i(i, t) {
                        function r() {
                            ...
                            var e = {
                                drm: {
                                    requestLicenseKey: g.requestLicenseKey(i),
                                    servers: {}
                                }
                            };
                        ...
                        i.destroy(function(t) {
                            try {
                                ...
                                if (e) {
                                    ...
                                    t.__support ? o(i) : shaka.Player.probeSupport().then(function(e) {
                                        t.__support = e,
                                        o(i)
                                    })
                                } else
                    ...
                    (that = this)._isLoadedDrm && "undefined" != typeof shaka ? i(this, e) : (this.trigger(y.Private.H5_Loading_Show),
                    function(e) {
                        var t = "aliplayer-drm-min.js"
                          , i = "https://" + d.domain + "/de/prismplayer/" + d.h5Version + "/drm/" + t;
                        d.domain ? -1 < d.domain.indexOf("g-assets.daily") ? i = "http://" + d.domain + "/de/prismplayer/" + d.h5Version + "/drm/" + t : -1 < d.domain.indexOf("localhost") && (i = "http://" + d.domain + "/build/drm/" + t) : i = this._options && this._options.sdkDomain ? this._options.sdkDomain + "/de/prismplayer/" + d.h5Version + "/drm/" + t : "de/prismplayer/" + d.h5Version + "/drm/" + t;
                        var r = this;
                        c.loadJS(i, function() {
        ...
        t.exports.inject = function(e, t, i, r, s, o) {
            ...
            if (o || function(e, t) {
                ...
                t.prototype.toEnd = function(e) {
                    ...
                    // console.log(this.tag.buffered.end(0));
                    // console.log(this._flv)
                    try {
                        this._flv.currentTime = this.tag.buffered.end(0) - 0.1;
                    } catch (e) {
                        console.log(e)
                    }
                    return this
            ...
            if (n || o || function(e, t, i, r) {
                ...
                t.prototype.initPlay = function(e) {
                    ...
                    function i(a, e) {
                        ...
                        a._options.defaultBandwidth && (i.defaultBandwidth = a._options.defaultBandwidth),
                        ...
                        a._options.hlsBandWidthUpCacheTime && (i.abrBandWidthUpCacheTime = a._options.hlsBandWidthUpCacheTime),
                        ...
                        a._hls.on(Hls.Events.MEDIA_ATTACHED, function() {
                            ...
                            a._hls.on(Hls.Events.LEVEL_SWITCHED, function(e, t) {
                                if (a._qualityService) {
                                    ...
                                    o && a.trigger(g.Private.QualityChange, {
                                        levelSwitch: !0,
                                        url: i,
                                        desc: o
                                    })
                            ...
                            a._levels && 1 < a._levels.length ? (a._hls.trigger(Hls.Events.MANIFEST_LOADING, {}),
                            a._hls.trigger(Hls.Events.MANIFEST_LOADED, {
                                levels: a._levels
                    ...
                    function(e, t, i) {
                        ...
                        d.domain ? -1 < d.domain.indexOf("g-assets.daily") ? o = "http://" + d.domain + "/de/prismplayer/" + d.h5Version + "/hls/" + r : -1 < d.domain.indexOf("localhost") && (o = "http://" + d.domain + "/build/hls/" + r) : o = this._options && this._options.sdkDomain ? this._options.sdkDomain + "/de/prismplayer/" + d.h5Version + "/hls/" + r : "de/prismplayer/" + d.h5Version + "/hls/" + r;
                        var n = this;
                        c.loadJS(o, function() {
                            e.apply(n)
                        })
                    ...
                    e.on(Hls.Events.ERROR, function(e, t) {
                        if (l._options && t.details != Hls.ErrorDetails.FRAG_LOOP_LOADING_ERROR && 1 != l._seeking && (0 != t.fatal || t.type == Hls.ErrorTypes.NETWORK_ERROR)) {
                            ...
                            if (t.details == Hls.ErrorDetails.MANIFEST_LOAD_ERROR) {
                                ...
                                y.get("Error_Not_Found")) : "403" == t.response.code ? (i = p.ErrorCode.AuthKeyExpired,
                                y.get("Error_AuthKey_Text")) : "0" == t.response.code && navigator.onLine ? (i = p.ErrorCode.RequestDataError,
                                r + "\uff0c" + y.get("Maybe_Cors_Error")) : y.get("Error_Load_M3U8_Failed_Text") : y.get("Error_Load_M3U8_Failed_Text")
                            } else
                                t.details == Hls.ErrorDetails.MANIFEST_LOAD_TIMEOUT ? (o = !0,
                                r = y.get("Error_Load_M3U8_Timeout_Text")) : t.details == Hls.ErrorDetails.MANIFEST_PARSING_ERROR || t.details == Hls.ErrorDetails.MANIFEST_INCOMPATIBLE_CODECS_ERROR ? (o = !0,
                                r = y.get("Error_M3U8_Decode_Text")) : t.type == Hls.ErrorTypes.NETWORK_ERROR ? (i = p.ErrorCode.NetworkError,
                                r = y.get("Error_Network_Text")) : t.type != Hls.ErrorTypes.MUX_ERROR && t.type != Hls.ErrorTypes.MEDIA_ERROR || (i = p.ErrorCode.PlayDataDecode,
                                r = y.get("Error_TX_Decode_Text"));
                            r = r + "(" + t.details + ")";
                            function n() {
                                if (l.pause(),
                                setTimeout(function() {
    ...
    83: [function(e, t, i) {
        ...
        t.exports.getDataByAuthInfo = function(e, a, s, l) {
            ...
            var r = c.makeUTF8sort(i, "=", "&") + "&Signature=" + c.AliyunEncodeURI(c.makeChangeSiga(i, e.accessSecret))
    ...
    85: [function(e, t, i) {
        ...
        e("../../lang/index"))
          ...
          , s = e("../../config")
          , T = e("../../lib/playerutil")
          , b = e("../base/event/eventtype")
          , x = f.extend({
            init: function(e, t) {
                this._authKeyExpiredHandle = new a(this),
                f.prototype._videoCreateEl || (f.prototype._videoCreateEl = f.prototype.createEl),
                "mp3" == t.format ? (t.height = "auto",
                t.mediaType = "audio",
                f.prototype.createEl = r.prototype.createEl,
                r.call(this, e, t),
                x.prototype.play = f.prototype.play,
                x.prototype.pause = f.prototype.pause,
                x.prototype.initPlay = f.prototype.initPlay,
                x.prototype.replay = f.prototype.replay,
                x.prototype.stop = f.prototype.stop,
                x.prototype.seek = f.prototype.seek) : (f.prototype.createEl = f.prototype._videoCreateEl,
                t._native = !1,
                f.call(this, e, t))
            }
        });
        x.prototype.loadData = function(e, t) {
            if ("undefined" != typeof _sce_r_skjhfnck || "" != e.format && "m3u8" != e.format && 1 != this._options.encryptType)
                ...
                s.domain ? -1 < s.domain.indexOf("g-assets.daily") ? r = "http://" + s.domain + "/de/prismplayer/" + s.h5Version + "/hls/" + i : -1 < s.domain.indexOf("localhost") && (r = "http://" + s.domain + "/build/hls/" + i) : r = this._options && this._options.sdkDomain ? this._options.sdkDomain + "/de/prismplayer/" + s.h5Version + "/hls/" + i : "de/prismplayer/" + s.h5Version + "/hls/" + i;
                var o = this;
                n.loadJS(r, function() {
                    o._loadData(e, t)
                })
        ...
        ,
        x.prototype._loadData = function(u, c) {
            ...
            "" != u.format && "m3u8" != u.format || 1 != this._options.encryptType)
                u.rand = o.randomUUID();
            else {
                var h = _sce_r_skjhfnck();
                u.rand = _sce_lgtcaygl(h)
            }
            this.trigger(b.Private.H5_Loading_Show),
            this.service.getDataByAuthInfo(u, this._options.qualitySort, function(e) {
                if (e.urls && 0 == e.urls.length)
                    p._mtsError_message(p, {
                        Code: _.ErrorCode.URLsIsEmpty,
                        Message: m.get("Error_Vod_URL_Is_Empty_Text") + (u.format ? "(format:" + u.format + ")" : "")
                    }, "");
                else {
                    p.log("COMPLETEFETCHDATA", {
                        cost: (new Date).getTime() - d,
                    ...
                    p._urls = e.urls,
                    p._currentPlayIndex = T.findSelectedStreamLevel(p._urls, u.defaultDefinition);
                    var t = (o = e.urls[p._currentPlayIndex]).Url;
                    if (p._vodDuration = o.duration || 0,
                    p._options.source = t,
                    p.encType = "",
                    p.trigger(b.Private.PREPARE, o.definition),
                    p.UI.cover && e.coverUrl && !p._options.cover && p.setCover(e.coverUrl),
                    T.isHls(t)) {
                        var i;
                        if (e.encryptUrlArr && 0 < e.encryptUrlArr.length) {
                            ...
                            for (var r = 0; r < e.encryptUrlArr.length; ++r) {
                                var o;
                                if ((o = e.encryptUrlArr[r]).encryptionType === _.EncryptionType.Private) {
                                    var n = _sce_dlgtqred(h, o.rand, o.plaintext);
                                    i.push({
                                        url: o.Url,
                                        secData: n
                                    })
                        ...
                        o.encryptionType == _.EncryptionType.Private) {
                            p.encType = o.encryptionType;
                            var a = T.checkSecuritSupport();
                            if (a)
                                return void p._mtsError_message(p, {
                                    Code: _.ErrorCode.EncrptyVideoNotSupport,
                                    Message: a,
                                    display_msg: a
                                }, "");
                            i = _sce_dlgtqred(h, o.rand, o.plaintext)
                        }
                        y.inject(p, x, f, p._options, i)
                    } else
                        T.isFlv(t) ? g.inject(p, x, f, p._options) : T.isDash(t) ? v.inject(p, x, f, p._options) : p._player._executeReadyCallback();
                    p._authKeyExpiredHandle.tick(_.AuthKeyRefreshExpired),
                    p.trigger(b.Private.SourceLoaded, o),
                    p.initPlay(c),
                    p.trigger(b.Private.ChangeURL),
                    e.thumbnailUrl && p._thumbnailService.get(e.thumbnailUrl);
                    var s = p._player._isFlv
                      , l = -1 < p._player.getOptions().source.indexOf("mp4");
                    1 == p._player.encType || s || l || (S.IS_IOS || S.IS_MAC_SAFARI || S.IS_X5 || S.IS_EDGE) && p._player._executeReadyCallback()
                }
            }, function(e) {
                p._mtsError_message(p, e, "")
            })
        }
        ,
        x.prototype._changeStream = function(e, t) {
            this._urls.length > e && (this.loadByUrl(this._urls[e].Url, this.getCurrentTime()),
            this._currentPlayIndex = e,
            this.trigger(b.Private.QualityChange, t || m.get("Quality_Change_Fail_Switch_Text")))
        }
        ,
        x.prototype._getLowerQualityLevel = function() {
        ...
        ,
        x.prototype._mtsError_message = function(e, t, i) {
            var r = e;
            r.trigger(b.Private.H5_Loading_Hide);
            var o = t.Code ? t.Code : "OTHER_ERR_CODE"
              , n = t.Message ? t.Message : "OTHER_ERR_MSG"
              , a = (_.ErrorCode.ServerAPIError,
            t.display_msg || "");
            -1 < n.indexOf("InvalidParameter.Rand") || -1 < n.indexOf('"Rand" is not valid.') ? (_.ErrorCode.EncrptyVideoNotSupport,
            a = m.get("Error_Not_Support_encrypt_Text")) : -1 < n.indexOf("SecurityToken.Expired") ? (_.ErrorCode.AuthKeyExpired,
            a = m.get("Error_Playauth_Expired_Text")) : -1 < n.indexOf("InvalidVideo.NoneStream") && (_.ErrorCode.URLsIsEmpty,
            a = m.get("Error_Fetch_NotStream") + "(" + r._options.format + "|" + r._options.definition + ")");
            ...
            t.sri && (l.sri = t.sri),
            r.logError(l),
            l.display_msg = (a || m.get("Error_Vod_Fetch_Urls_Text")) + "</br>" + n,
            r.trigger("error", l),
    ...
    89: [function(e, t, i) {
        ...
        function f(e, t) {
            for (var i, r, o = [], n = [], a = [], s = [], l = e.length - 1; 0 <= l; l--) {
                ...
                (r = {}).width = (i = u).Width,
                r.height = i.Height,
                r.definition = i.Definition,
                r.Url = i.PlayURL,
                r.format = i.Format,
                r.desc = p.QualityLevels[r.definition],
                r.encryptionType = p.VodEncryptionType[i.EncryptType],
                r.plaintext = i.Plaintext,
                r.rand = i.Rand,
                r.encrypt = i.Encrypt,
                r.duration = i.Duration,
                r.bitrate = i.Bitrate,
                r);
                "mp4" == c.format ? n.push(c) : "mp3" == c.format ? a.push(c) : "m3u8" == c.format ? o.push(c) : s.push(c)
            }
            var d = [];
            return d = 0 < a.length ? a : 0 < n.length ? n : 0 < o.length ? o : s,
            "asc" == t && d.reverse(),
            d
        }
        t.exports.getDataByAuthInfo = function(e, u, c, d) {
            ...
            "AUTO" === e.definition ? i.ResultType = "Multiple" : e.definition && (i.Definition = e.definition),
            ...
            var r = a.makeUTF8sort(i, "=", "&") + "&Signature=" + a.AliyunEncodeURI(a.makeChangeSiga(i, e.accessSecret))
            ...
            n.get(o, function(e) {
                if (e) {
                    ...
                    for (var o = t.PlayInfoList.PlayInfo, n = [], a = [], s = o.length - 1; 0 <= s; --s) {
                        if ("AUTO" === o[s].Definition)
                            n = [o.splice(s, 1)[0]];
                        else
                            1 === o[s].Encrypt && a.push(o[s])
                    }
                    var l = null;
                    a = 0 === n.length ? (l = f(o, u),
                    []) : (l = f(n),
                    f(a)),
                    l && c && c({
                        requestId: t.RequestId,
    ...
    92: [function(e, t, i) {
        function r(e) {
            ...
            e.on(o.Player.CanPlay, function() {
                ...
                e.trigger(o.Player.TextTrackReady, t.tracks)),
                t._isCreated && !t._player._setDefaultCC || !t._defaultTrack || (e.trigger(o.Private.SelectorUpdateList, {
                    type: "cc",
            ...
            e.on(o.Player.RequestFullScreen, function() {
                t._adaptiveCueStype()
            }),
    ...
    94: [function(e, t, i) {
        ...
        r.prototype.dispose = function() {
            this._player = null;
            var e = c;
            e && a.off(document, e.eventName, this._fullscreenChanged)
        }
        ;
        var d = function() {
            this.isFullWindow = !0,
    ...
    95: [function(e, t, i) {
        ...
        function n(e, t) {
            ...
            e.currentTime = s.convertToDate(t),
            e.currentTimeDisplay = s.extractTime(e.currentTime),
            e.liveShiftStart = e.liveTimeRange.start,
            e.liveShiftEnd = e.liveTimeRange.end,
            e.liveShiftStartDisplay = s.extractTime(e.liveShiftStart),
            e.liveShiftEndDisplay = s.extractTime(e.liveShiftEnd),
            e.availableLiveShiftTime = t - e.liveShiftStart.valueOf() / 1e3,
            e.timestampStart = s.convertToTimestamp(e.liveShiftStart),
            e.timestampEnd,
            s.convertToTimestamp(e.liveShiftEnd))
        }
        function r(t) {
            function e() {
        ...
        r.prototype.getSourceUrl = function(e, t) {
            ...
            (e = parseInt(e)) <= 5 && (e = 5),
            i = -1 == (i = (i = this._switchLiveShiftPlayer(t)) && i.replace("lhs_offset_unix_s_0", "z")).indexOf("?") ? i + "?lhs_offset_unix_s_0=" + e : i + "&lhs_offset_unix_s_0=" + e)
        }
        ,
        r.prototype._switchLiveShiftPlayer = function(e) {
            ...
            if (l.isHls(r))
                ...
                c.inject(this._player, n, o, this._player._options, "", !0),
                i
            }
            return t
        }
        ...
        r.prototype.getTimeline = function(i, r) {
            if (this._player.trigger(p.Private.LiveShiftQueryCompleted),
            !this._liveShiftUrl)
                return n(this, (new Date).valueOf() / 1e3),
                void (i && i());
            var o = this;
            this.queryLiveShift(this._liveShiftUrl, function(e) {
                if (e) {
                    var t = e;
                    0 == t.retCode ? (n(o, t.content.current),
                    i && i()) : r({
                ...
                if (r && e) {
                    ...
                    if (e) {
                        if (-1 < e.indexOf("403 Forbidden"))
                            ...
                            t.Message = "Query liveshift failed:" + u.get("Error_AuthKey_Text");
                        else {
                            var i;
                            t = e;
                            try {
                            ...
                            i && (t.Code = d.ErrorCode.ServerAPIError,
            ...
            var e = this
              , t = function() {
                e._localLiveTimeHandler = setTimeout(function() {
                    e.currentTimestamp++,
                    n(e, e.currentTimestamp),
                    e._player.trigger(p.Private.LiveShiftQueryCompleted),
                    t()
                }, 1e3)
            };
            t()
        ...
        function r(a) {
            ...
            a.on(l.Player.LevelsLoaded, function(e) {
                ...
                (e = e.paramData) && e.levels) {
                    ...
                    if ("AUTO" === a._options.definition && (a._urls = [],
                    Object.assign(a._urls, this.levels)),
                    0 < s.levels.length) {
                        var n = u.get("Auto");
                        s.levels.push({
                            Url: e.url,
            ...
            get: function(e) {
                ...
                o.get(e, function(e) {
                    e && a.parse(e, function(e) {
                        t.cues = e,
                        t._player.trigger(s.Private.ThumbnailLoaded, e)
                    })
                }, function(e) {
                    console.log(e)
                })
        ...
        e("../../lib/event"))
          ...
          , p = r.extend({
            ...
            bindEvent: function() {
                ...
                u.domain ? -1 < u.domain.indexOf("localhost") && (r = "//" + u.domain + "/build/skins/default/img/dragcursor.png") : r = this._player && this._player._options && this._player._options.sdkDomain ? this._player._options.sdkDomain + "/de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png" : "de/prismplayer/" + u.h5Version + "/skins/default/img/dragcursor.png",
                e.src = r,
            ...
            _onMouseClick: function(e) {
                ...
                if (t._canSeekable(i)) {
                    ...
                    this._mouseClickTimeHandle = setTimeout(function() {
                        ...
                        t._mouseDown || t._player.trigger(d.Private.SeekStart, {
            ...
            _onTimeupdate: function(e) {
                var t = this._player.tag.currentSrc.split(".")
                  , i = !(!t || "mp4" !== t[t.length - 1])
                  , r = !1;
                this.thumbnailNode && (this.thumbnailNode.style.display = "none"),
                i && (s.IS_MAC_SAFARI && (r = !0),
                s.IS_IOS && (r = !0)),
                (this._inWaitingSeek || this._player._seeking && !s.IS_EDGE || this._progressDown) && !r || (this._updateProgressBar(this.playedNode, this._player.getCurrentTime()),
            ...
            _updateProgressBar: function(e, t) {
                ...
                if (1 != this._player._switchSourcing && i) {
                    -1 != this._seekTime && (this._player.getCurrentTime() >= this._seekTime || !this._player._seeking ? this._seekTime = -1 : t = this._seekTime);
                    var r = t / i + .005;
                    1 < r && (r = 1),
            ...
            execute: function(e) {
                ...
                this._isMasterLevel) {
                    ...
                    if (r != o && -1 < o) {
                        ...
                        this._player._switchLevel && !this._player._options.isLive ? this._player._switchLevel(e) : this._player._loadByUrlInner(e, a, s)
                    }
                }
                var l = this;
                setTimeout(function() {
    ...
    126: [function(e, t, i) {
        ...
        t.exports.registerTooltipEvent = function(e, o) {
            function n() {
                a._controlbarTooltipHandler && (clearTimeout(a._controlbarTooltipHandler),
