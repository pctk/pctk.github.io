    ...
    */
    ...
    function decode(e, port, t) {
        ...
        for (this.buffer ? this.buffer = o(this.buffer, e).buffer : this.buffer = e; this.buffer && this.buffer.byteLength > 0; ) {
            ...
            if ((a.indexOf('type@=rquizisn') > -1 && a.indexOf('qs@AA=3') > -1) || a.indexOf('type@=quizprn') > -1) {
                console.log('--dm不显示的原因-' + a);
            }
            // console.log('--neww---dm-' + a);
    ...
    function connectSocket(port) {
        ...
        danmuWebSocket.onopen = function () {
            ...
            sendMessage(danmuWebSocket, `type@=loginreq/roomid@=${roomId}/dfl@=/username@=${UserName}/uid@=${UId}/ver@=20190530/aver@=218101901/ct@=0/`);
    ...
    function connectLn() {
        ...
        webSocket.onopen = function () {
            ...
            // type@=loginreq/roomid@=${roomId}/dfl@=/username@=/password@=/ltkid@=/biz@=/stk@=/devid@=${DevicesId}/ct@=0/pt@=2/rt@=${now}/vk@=${vk}/ver@=20190530/aver@=218101901/dmbt@=chrome/dmbv@=69/
            
            // sendMessage(webSocket, `type@=loginreq/roomid@=${roomId}/dfl@=/username@=/password@=/ltkid@=/biz@=/stk@=/devid@=${DevicesId}/ct@=0/pt@=2/rt@=${now}/vk@=${vk}/ver@=20190530/aver@=218101901/dmbt@=chrome/dmbv@=69/`);
            
            // 测试
            // 下send---wss://wsproxy.douyu.com:6675/---type@=loginreq/roomid@=691696/dfl@=/username@=/password@=/ltkid@=/biz@=/stk@=/devid@=c572bd7649f9b8c00b2ad23c00061501/ct@=0/pt@=2/rt@=1560161457/vk@=a5b014dd0a86825a7c87b8dc10128620/ver@=20190530/aver@=218101901/dmbt@=chrome/dmbv@=73/
            sendMessage(webSocket, `type@=loginreq/roomid@=${roomId}/dfl@=/username@=/password@=/ltkid@=/biz@=/stk@=/devid@=${DevicesId}/ct@=0/pt@=2/rt@=${now}/vk@=${vk}/ver@=20190530/aver@=218101901/dmbt@=chrome/dmbv@=73/`);
            // sendMessage(webSocket, `type@=loginreq/roomid@=${roomId}/dfl@=/username@=${UserName}/password@=/ltkid@=${ltkid}/biz@=1/stk@=${acfStk}/devid@=${DevicesId}/ct@=0/pt@=2/rt@=${now}/vk@=${vk}/ver@=20190530/aver@=218101901/dmbt@=chrome/dmbv@=69/`);
