window.Player = function(e) {
    ...
    var p = function(e) {
        function t(e) {
            ...
            n.userTimer = null,
            n.waitTimer = null,
            n.database = new a.default,
            n.history = [],
            n.isProgressMoving = !1,
            n.root = i.default.findDom(document, "#" + n.config.id),
            n.controls = i.default.createDom("xg-controls", "", {
                unselectable: "on",
            ...
            !n.root) {
                var r = n.config.el;
                if (!r || 1 !== r.nodeType)
                    return n.emit("error", new l.default("use",n.config.vid,{
                        line: 32,
                        handle: "Constructor",
            ...
            if (i.default.addClass(n.root, "xgplayer xgplayer-" + s.default.device + " xgplayer-nostart " + (n.config.controls ? "" : "no-controls")),
            ...
            n.config.controlStyle && "String" === i.default.typeOf(n.config.controlStyle)) {
                ...
                fetch(o.config.controlStyle, {
                    ...
                    e.ok && e.json().then(function(e) {
                        for (var t in e)
                            e.hasOwnProperty(t) && (o.config[t] = e[t]);
                        o.pluginsCall()
                    })
                }).catch(function(e) {
        ...
        r(t, [{
            ...
            value: function() {
                ...
                function a() {
                    for (var e in this.emit("destroy"),
                    this.video.removeAttribute("src"),
                    this.video.load(),
                    n && o.removeChild(this.root),
                    this)
                        "config" !== e && delete this[e];
                    this.off("pause", a)
                }
                ...
                this.paused ? a.call(this) : (this.pause(),
                this.once("pause", a)),
                function e(t, n, r) {
            ...
            value: function() {
                var e = this
                  , t = this._replay;
                i.default.removeClass(this.root, "xgplayer-ended"),
                this.logParams = {
                    bc: 0,
                    bu_acu_t: 0,
                    played: [],
            ...
            value: function() {
                var e = this;
                i.default.removeClass(this.root, "xgplayer-inactive"),
            ...
            key: "onPlay",
            value: function() {
                i.default.addClass(this.root, "xgplayer-playing"),
                i.default.removeClass(this.root, "xgplayer-pause")
            }
        }, {
            key: "onPause",
            value: function() {
                i.default.addClass(this.root, "xgplayer-pause"),
            ...
            key: "onEnded",
            value: function() {
                i.default.addClass(this.root, "xgplayer-ended"),
                i.default.removeClass(this.root, "xgplayer-playing")
            }
        }, {
            key: "onSeeking",
            value: function() {}
            ...
            value: function() {
                ...
                i.default.removeClass(this.root, "xgplayer-isloading")
            }
        }, {
            key: "onWaiting",
            value: function() {
            ...
            value: function() {
                this.waitTimer && clearTimeout(this.waitTimer),
                i.default.removeClass(this.root, "xgplayer-isloading xgplayer-nostart xgplayer-pause xgplayer-ended xgplayer-is-error xgplayer-replay"),
                i.default.addClass(this.root, "xgplayer-playing")
            }
        }, {
            key: "onKeydown",
            value: function(e, t) {
                ...
                if (!n || 37 !== n.keyCode && 38 !== n.keyCode && 39 !== n.keyCode && 40 !== n.keyCode && 32 !== n.keyCode || t.emit("focus"),
                !n || 40 !== n.keyCode && 38 !== n.keyCode)
                    n && 39 === n.keyCode ? t.currentTime + 10 <= t.duration ? t.currentTime += 10 : t.currentTime = t.duration - 1 : n && 37 === n.keyCode ? t.currentTime - 10 >= 0 ? t.currentTime -= 10 : t.currentTime = 0 : n && 32 === n.keyCode && (t.paused ? t.play() : t.pause());
                else {
                    if (t.controls) {
                        var r = t.controls.querySelector(".xgplayer-slider");
                        r && (i.default.hasClass(r, "xgplayer-none") && i.default.removeClass(r, "xgplayer-none"),
...
, function(e, t, n) {
    ...
    for (var l in a.default)
        a.default[l]instanceof Function && !s.prototype[l] && (s.prototype[l] = a.default[l]);
    t.default = s,
    e.exports = t.default
}
...
, function(e, t, n) {
    ...
    var i = void 0
      ...
      , w = void 0
      , _ = void 0;
    -1 !== (w = p.indexOf("Opera")) && (b = "Opera",
    x = p.substring(w + 6),
    -1 !== (w = p.indexOf("Version")) && (x = p.substring(w + 8))),
    -1 !== (w = p.indexOf("Edge")) ? (b = "Microsoft Edge",
    x = p.substring(w + 5)) : -1 !== (w = p.indexOf("MSIE")) ? (b = "Microsoft Internet Explorer",
    x = p.substring(w + 5)) : -1 !== (w = p.indexOf("Chrome")) ? (b = "Chrome",
    x = p.substring(w + 7)) : -1 !== (w = p.indexOf("Safari")) ? (b = "Safari",
    x = p.substring(w + 7),
    -1 !== (w = p.indexOf("Version")) && (x = p.substring(w + 8))) : -1 !== (w = p.indexOf("Firefox")) && (b = "Firefox",
    x = p.substring(w + 8)),
    -1 !== (_ = x.indexOf(";")) && (x = x.substring(0, _)),
    -1 !== (_ = x.indexOf(" ")) && (x = x.substring(0, _)),
    -1 !== (_ = x.indexOf(")")) && (x = x.substring(0, _));
    ...
    switch (/Windows/.test(y) && (m = O(/Windows (.*)/, y),
    y = "windows"),
    y) {
    case "Mac OS X":
        ...
        break;
    case "Android":
        (E = O(/Android ([\.\_\d]+)/, k = p)) || (E = O(/Android\/([\.\_\d]+)/, k)),
        m = E,
        y = "android";
        break;
    case "iOS":
    ...
    var J = new (function(e) {
        function t() {
            ...
            return n.initClientEnv = function() {
                n.set("os_name", M.os_name),
                n.set("os_version", M.os_version),
                n.set("device_model", M.device_model),
                n.set("platform", M.platform),
                n.set("sdk_version", K),
                n.set("browser", M.browser),
                n.set("browser_version", M.browser_version),
                n.set("language", M.language),
                n.set("timezone", W),
                n.set("tz_offset", V),
                n.set("resolution", M.screen_width + "x" + M.screen_height),
                n.set("screen_width", M.screen_width),
                n.set("screen_height", M.screen_height),
                n.set("referrer", M.referrer),
                n.set("referrer_host", M.referrer_host),
                n.set("utm_source", M.utm_source),
                n.set("utm_medium", M.utm_medium),
                n.set("utm_campaign", M.utm_campaign),
                n.set("utm_term", M.utm_term),
                n.set("utm_content", M.utm_content)
            }
            ,
            n.initClientEnv(),
            n
        ...
        function t() {
            ...
            n.verifyTokens = function(e) {
                ...
                if (r.user_unique_id === n.realUuid && r.ssid && r.web_id)
                    ...
                    var o = Y({}, n.getUserTokens(), {
                        user_unique_id: n.realUuid
                    });
                    if (D.set(t, JSON.stringify(o)),
                    X.isLowIE())
                        return n.unlock(),
                        !1;
            ...
            n.mergeEnv = function() {
                var e = n.get()
                  , t = J.get()
                  , r = Y({}, e.user)
                  , o = Y({}, t.header.headers.custom, e.header.headers.custom)
                  , i = Y({}, t.header.headers, e.header.headers, {
                    custom: o
                })
                  , a = Y({}, t.header, e.header);
                return {
                    user: r,
                    header: Y({}, a, {
    ...
    var oe = function() {
        function e(t) {
            ...
            this._storage = this._isPersistent ? D : new ne,
            this._storageKey = "",
            this._data = void 0
        }
            ...
            if (function(e) {
                ...
                if (window.XDomainRequest)
                    ...
                    if (a)
                        ...
                        void (window.navigator.sendBeacon(t, JSON.stringify(s)) ? r() : o(t, n, j))) : void se(t, s, r, o);
    ...
    var de = function(e) {
        function t(n) {
            ...
            o.setReady = function(e) {
                o.isReady = e,
                o.eventSender.isSdkMonitorDisabled = o.isSdkMonitorDisabled,
                o.checkAndSendCachedStorageEvents(),
                o.report()
            }
            ,
            o.eventReportTimer = null,
            o.event = function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : []
                  , t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
                  , n = re.get(o.evtDataCacheKey) || []
                  , r = t ? [].concat(e, n) : [].concat(n, e);
                re.set(o.evtDataCacheKey, r),
                r.length >= 5 ? o.report() : (o.eventReportTimer && clearTimeout(o.eventReportTimer),
            ...
            o.sendData = function(e, t) {
                ...
                e.forEach(function(e) {
                    ...
                    void 0 === i ? i = t : (t !== i || n[r].length >= 5) && (r += 1,
                    i = !i),
                    n[r] = n[r] || [],
                    n[r].push(e)
                }),
                n.forEach(function(e) {
                    var n = G();
                    e[0].__disable_storage__ || o.eventStorage.add(n, e),
                    o._sendData(n, e, t)
                })
            }
            ,
            ...
            return o.init(n),
            o.maxBatchNum = l,
            o.waitForBatchTime = c,
            o.isReady = !1,
            o.addListener(),
            o.enableDebugMode(!!i),
            o.eventStorage = new oe({
                disable_storage: a
            }),
            o.eventStorage.setStorageKey(o.evtDataCacheKey),
            o.eventSender = new le({
                logger: o.logger
            }),
            o.reportErrorCallback = function() {}
            ,
            o
        }
        return function(e, t) {
    ...
    var fe = function() {
      ...
      , ge = function e(t) {
        ...
        this.config = function(e) {
            X.isObj(e) || n.logger.throw("config 参数必须是 {} 的格式"),
    ...
    t.default = function e(t) {
        ...
        this._executeCmd = function() {
            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++)
                t[r] = arguments[r];
            var o, i, a = t[0];
            ge.exportMethods.indexOf(a) > -1 ? (o = n.colloctor)[a].apply(o, t.slice(1)) : (i = n.colloctor).event.apply(i, t)
        }
        ,
...
, function(e, t, n) {
    ...
    M(O, ["control", "collect"], T.default),
    M(O, ["control", "danmu"], S.default),
    M(O, ["control", "definition"], C.default),
    M(O, ["control", "download"], E.default),
    M(O, ["control", "error"], k.default),
    M(O, ["control", "flex"], _.default),
    M(O, ["control", "fullscreen"], w.default),
    M(O, ["control", "i18n"], x.default),
    M(O, ["control", "loading"], b.default),
    M(O, ["control", "localPreview"], m.default),
    M(O, ["control", "logger"], y.default),
    M(O, ["control", "mobile"], v.default),
    M(O, ["control", "pc"], h.default),
    M(O, ["control", "pip"], g.default),
    M(O, ["control", "play"], f.default),
    M(O, ["control", "playbackRate"], p.default),
    M(O, ["control", "poster"], d.default),
    M(O, ["control", "progress"], c.default),
    M(O, ["control", "replay"], u.default),
    M(O, ["control", "rotate"], l.default),
    M(O, ["control", "screenShot"], s.default),
    M(O, ["control", "textTrack"], a.default),
    M(O, ["control", "time"], i.default),
    M(O, ["control", "volume"], o.default),
    t.default = r.default,
    e.exports = t.default
}
, function(e, t, n) {
    ...
    var l = function() {
        function e(t) {
            ...
            t.textTrackStyle) {
                ...
                for (var l in t.textTrackStyle)
                    s += l + ": " + t.textTrackStyle[l] + ";";
                var u = t.id ? "#" + t.id : t.el.id ? "#" + t.el.id : "." + t.el.className;
                r.sheet.insertRule ? r.sheet.insertRule(u + " video::cue { " + s + " }", 0) : r.sheet.addRule && r.sheet.addRule(u + " video::cue", s)
            }
            this.video = i.default.createDom(this.videoConfig.mediaType, n, this.videoConfig, ""),
            ...
            this.ev.forEach(function(e) {
                ...
                d.video.addEventListener(Object.keys(e)[0], function() {
                    ...
                    "error" === t ? d.video.error && d.emit(t, new a.default("other",d.currentTime,d.duration,d.networkState,d.readyState,d.currentSrc,d.src,d.ended,{
                        line: 41,
                        msg: d.error,
                        handle: "Constructor"
                    })) : d.emit(t, d),
                    d.hasOwnProperty("_interval") && (["ended", "error", "timeupdate"].indexOf(t) < 0 ? (clearInterval(d._interval.bufferedChange),
                    i.default.setInterval(d, "bufferedChange", function() {
        ...
        return r(e, [{
            ...
            set: function(e) {
                var t = this;
                i.default.hasClass(this.root, "xgplayer-ended") || this.emit("urlchange", JSON.parse(JSON.stringify(t.logParams))),
                this.logParams = {
                    bc: 0,
                    bu_acu_t: 0,
                    played: [],
...
, function(e, t, n) {
    ...
    , d = n(12), p = n(26), f = Function.prototype.apply, g = Function.prototype.call, h = Object.create, v = Object.defineProperty, y = Object.defineProperties, m = Object.prototype.hasOwnProperty, b = {
        configurable: !0,
        enumerable: !1,
        writable: !0
    };
    ...
    i = function() {
        var e = function() {
          ...
          , i = function(i) {
            ...
            k > 1 && (c *= Math.sqrt(k),
            d *= Math.sqrt(k));
            var E = function(e, n, r, i, a, s, l, u, c, d, p, f) {
                var g = Math.pow(a, 2)
                  , h = Math.pow(s, 2)
                  , v = Math.pow(p, 2)
                  , y = Math.pow(f, 2)
                ...
                m < 0 && (m = 0),
                m /= g * y + h * v;
                var b = (m = Math.sqrt(m) * (l === u ? -1 : 1)) * a / s * f
                  , x = m * -s / a * p
                  , w = d * b - c * x + (e + r) / 2
                  , _ = c * b + d * x + (n + i) / 2
                  , k = (p - b) / a
                ...
                1 === u && P < 0 && (P += t),
                [w, _, T, P]
            }(a, s, l, u, c, d, h, y, b, x, w, _)
              , C = e(E, 4)
              , S = C[0]
              , T = C[1]
              , P = C[2]
              , O = C[3]
              , M = Math.max(Math.ceil(Math.abs(O) / (t / 4)), 1);
            O /= M;
            for (var D = 0; D < M; D++)
                m.push(r(P, O)),
                P += O;
            return m.map(function(e) {
                var t = n(e[0], c, d, x, b, S, T)
                  , r = t.x
                  , o = t.y
                  , i = n(e[1], c, d, x, b, S, T)
                  , a = i.x
        ...
        function d(e, t) {
            ...
            n.forEach(function(n) {
                ...
                n.forEach(function(n) {
                    ...
                    o += (r = u(e[n]),
                    i = u(t[n]),
                    Math.sqrt(Math.pow(r[0] - i[0], 2) + Math.pow(r[1] - i[1], 2)) + Math.sqrt(Math.pow(r[2] - i[2], 2) + Math.pow(r[3] - i[3], 2)))
                }),
                r.push({
                    index: n,
                    distance: o
        ...
        var p = {};
        function f(e, t, n, r, o, i, a, s, l, u) {
            var c = (n - e) * l + e
              , d = (r - t) * l + t
              , p = (o - n) * l + n
              , f = (i - r) * l + r
        ...
        p.path2shapes = function(e) {
            for (var t = p.parser(e), n = 0, r = 0, o = 0, a = t.length, s = [], l = null, u = void 0, c = void 0, d = void 0, f = void 0, g = void 0, h = void 0, v = void 0; o < a; o++) {
                var y = t[o]
                  , m = y[0]
                  , b = t[o - 1];
                switch (m) {
                ...
                case "A":
                    ...
                    break;
                case "Q":
                    l.push(p.q2b(n, r, y[1], y[2], y[3], y[4])),
                    n = y[3],
                    r = y[4];
                    break;
                case "q":
                    l.push(p.q2b(n, r, n + y[1], r + y[2], y[3] + n, y[4] + r)),
                    n += y[3],
                    r += y[4];
                    break;
                case "T":
                    "Q" === b[0] || "q" === b[0] ? (d = n + b[3] - b[1],
                    f = r + b[4] - b[2],
                    l.push(p.q2b(n, r, d, f, y[1], y[2]))) : "T" !== b[0] && "t" !== b[0] || (l.push(p.q2b(n, r, n + n - d, r + r - f, y[1], y[2])),
                    d = n + n - d,
                    f = r + r - f),
                    n = y[1],
                    r = y[2];
                ...
                case "t":
                    "Q" === b[0] || "q" === b[0] ? (d = n + b[3] - b[1],
                    f = r + b[4] - b[2],
                    l.push(p.q2b(n, r, d, f, n + y[1], r + y[2]))) : "T" !== b[0] && "t" !== b[0] || (l.push(p.q2b(n, r, n + n - d, r + r - f, n + y[1], r + y[2])),
                    d = n + n - d,
                    f = r + r - f),
                    n += y[1],
                    r += y[2];
        ...
        p._splitCurves = function(e, t) {
            for (var n, r, o, i, a, s, l, u, c, d = 0, p = 0; d < t; d++) {
                var g = e[p]
                  , h = (n = g[0],
                r = g[1],
                o = g[2],
                ...
                u = g[7],
                {
                    left: f(n, r, o, i, a, s, l, u, c = .5),
                    right: f(l, u, a, s, o, i, n, r, 1 - c, !0)
                });
                e.splice(p, 1),
                e.splice(p, 0, h.left, h.right),
                (p += 2) >= e.length - 1 && (p = 0)
            }
        }
        ,
        ...
        ,
        p.MIM_CURVES_COUNT = 100,
        p._preprocessing = function(e, t) {
            var n = e.length
              , r = t.length
              , o = JSON.parse(JSON.stringify(e))
              , i = JSON.parse(JSON.stringify(t));
            return n > r ? p._subShapes(o, i, n - r) : n < r && p._upShapes(o, r - n),
            (o = d(o, i)).forEach(function(e, t) {
                var n = e.length
                  , r = i[t].length;
                n > r ? n < p.MIM_CURVES_COUNT ? (p._splitCurves(e, p.MIM_CURVES_COUNT - n),
                p._splitCurves(i[t], p.MIM_CURVES_COUNT - r)) : p._splitCurves(i[t], n - r) : n < r && (r < p.MIM_CURVES_COUNT ? (p._splitCurves(e, p.MIM_CURVES_COUNT - n),
                p._splitCurves(i[t], p.MIM_CURVES_COUNT - r)) : p._splitCurves(e, r - n))
            }),
...
, function(e, t, n) {
    ...
    i.default.install("textTrack", function() {
        if (-1 !== navigator.userAgent.indexOf("Chrome")) {
            ...
            o && Array.isArray(o) && o.length > 1 && (t.addClass(e.root, "xgplayer-is-textTrack"),
            e.on("canplay", function() {
                var i = ["<ul>"];
                i.push("<li class=''}'>关闭</li>"),
            ...
            ["touchend", "click"].forEach(function(r) {
                n.addEventListener(r, function(n) {
                    ...
                    if (r && "li" === r.tagName.toLocaleLowerCase()) {
                        ...
                        "关闭" === r.innerHTML ? (i[0].track.mode = "hidden",
        ...
        if (e.config.screenShot) {
            ...
            ["click", "touchstart"].forEach(function(t) {
                n.addEventListener(t, function(t) {
                    t.preventDefault(),
                    t.stopPropagation(),
                    a.onload = (o.drawImage(e.video, 0, 0, r.width, r.height),
...
, function(e, t, n) {
    ...
    i.default.install("replay", function() {
        ...
        if (!(navigator.userAgent.indexOf("iPhone OS 9") > -1)) {
            if ("img" === n.type) {
                if (o = t.createDom("xg-replay", '<div class="xgplayer-replay-img"></div>', {}, "xgplayer-replay"),
                (a = o.querySelector(".xgplayer-replay-img")).style.backgroundImage = 'url("' + n.url.replay + '")',
                n.width && n.height) {
                    var l = void 0
                      , u = void 0
                      , c = void 0;
...
, function(e, t, n) {
    ...
    a = function() {
        ...
        var f = 0
          ...
          , m = 0
          , b = [];
        e.config.thumbnail && (f = e.config.thumbnail.pic_num,
        g = e.config.thumbnail.width,
        h = e.config.thumbnail.height,
        v = e.config.thumbnail.col,
        y = e.config.thumbnail.row,
        b = e.config.thumbnail.urls,
        d.style.width = g + "px",
        d.style.height = h + "px"),
            ...
            var o = n.getBoundingClientRect().left
              ...
              , a = function(r) {
                ...
                if (e.config.thumbnail) {
                    m = e.duration / f;
                    var l = Math.floor(a / m);
                    d.style.backgroundImage = "url(" + b[Math.ceil((l + 1) / (v * y)) - 1] + ")";
                    var u = l + 1 - v * y * (Math.ceil((l + 1) / (v * y)) - 1)
                      , p = Math.ceil(u / y) - 1
                      , x = u - p * y - 1;
                    d.style["background-position"] = "-" + x * g + "px -" + p * h + "px";
                    var w = r.clientX - o - g / 2;
                    w = (w = w > 0 ? w : 0) < i - g ? w : i - g,
                    d.style.left = w + "px",
                    d.style.top = -10 - h + "px",
                    d.style.display = "block",
                    c.style.left = w + g / 2 - s / 2 + "px"
                } else {
...
, function(e, t, n) {
    ...
    i.default.install("poster", function() {
        var e = i.default.util.createDom("xg-poster", "", {}, "xgplayer-poster")
          , t = this.root;
...
, function(e, t, n) {
    ...
    r.default.install("play", function() {
        var e = this
          ...
          , c = void 0
          , d = void 0;
        "img" === l.type ? u = r.default.util.createImgBtn("play", l.url.play, l.width, l.height) : (u = n.createDom("xg-play", '<xg-icon class="xgplayer-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">\n              <path transform="scale(' + i + " " + i + ')" d="' + a + '"></path>\n          </svg></xg-icon>', {}, "xgplayer-play"),
    ...
    r.default.install("pip", function() {
        ...
        if (e.config.pip) {
            var n = t.createDom("xg-pip", '<p class="name"><span>画中画</span></p>', {
              ...
              , i = t.createDom("xg-pip-lay", "<div></div>", {}, "xgplayer-pip-lay")
            ...
            ["click", "touchstart"].forEach(function(r) {
                n.addEventListener(r, function(n) {
                    ...
                    n.preventDefault(),
                    n.stopPropagation(),
                    t.hasClass(l, "xgplayer-pip-active") ? u(l) : (r = l,
                    o = e.root.getBoundingClientRect(),
                    a = o.top,
                    s = o.left,
                    t.addClass(r, "xgplayer-pip-active"),
        ...
        void 0 === (o = function(e, t) {
            return function(e, t, n) {
                ...
                a._create = function() {
                    ...
                    s[e.position] || (this.element.style.position = "relative"),
                ...
                a.containDrag = function(e, t, n) {
                    ...
                    return i = l(i, n, "floor"),
                    Math.max(o, Math.min(i, t))
                }
                ,
                ...
                a._init = function() {}
                ,
                o && o.bridget && o.bridget("draggabilly", i);
                return i
            }(i, e, t)
        }
...
, function(e, t, n) {
    ...
    void 0 === (o = "function" == typeof (r = function() {
        ...
        function l(t) {
            ...
            t && "object" == (void 0 === t ? "undefined" : i(t)) && t.nodeType) {
                var u = o(t);
                if ("none" == u.display)
                    return function() {
                        for (var e = {
...
, function(e, t, n) {
    ...
    i.default.install("pc", function() {
        var e = this
          ...
          , u = void 0
          , c = void 0;
        "img" === s.type ? u = i.default.util.createImgBtn("start", s.url.play, s.width, s.height) : (l = {
        ...
        ["click", "touchend"].forEach(function(n) {
            u.addEventListener(n, function(n) {
                !function(n) {
                    n.preventDefault(),
                    n.stopPropagation(),
                    t.hasClass(r, "xgplayer-nostart") ? (t.removeClass(r, "xgplayer-nostart"),
                    t.addClass(r, "xgplayer-is-enter"),
                    e.on("canplay", h),
                    e.once("playing", v),
                    r.querySelector("video") || e.start(),
                    e.play()) : e.paused && (t.removeClass(r, "xgplayer-nostart xgplayer-isloading"),
                    setTimeout(function() {
                        e.play()
                    }, 10))
                }(n)
        ...
        u.addEventListener("animationend", function(e) {
            !function(e) {
                e.preventDefault(),
                t.removeClass(u, "xgplayer-start-interact"),
                u.style.display = "none"
            }(e)
        }),
        e.on("play", function() {
            "img" === s.type ? u.style.backgroundImage = 'url("' + s.url.pause + '")' : c.setAttribute("d", l.pause),
            u.style.display = "inline-block",
            t.addClass(u, "xgplayer-start-interact")
        }),
        e.on("pause", function() {
            "img" === s.type ? u.style.backgroundImage = 'url("' + s.url.play + '")' : c.setAttribute("d", l.play),
            u.style.display = "inline-block",
            t.addClass(u, "xgplayer-start-interact")
        }),
        e.video.addEventListener("click", function(n) {
            !function(n) {
                n.preventDefault(),
                n.stopPropagation(),
                document.activeElement === e.video ? e.config.closeVideoClick || (o++,
                a && clearTimeout(a),
                1 === o ? a = setTimeout(function() {
                    if (t.hasClass(e.root, "xgplayer-nostart"))
                        return !1;
                    e.ended || (e.paused ? e.play() : e.pause()),
                    o = 0
        ...
        e.video.addEventListener("dblclick", function(t) {
            !function(t) {
                if (t.preventDefault(),
                t.stopPropagation(),
                document.activeElement === e.video) {
                    if (!e.config.closeVideoDblclick) {
                        var r = n.querySelector(".xgplayer-fullscreen");
                        if (r) {
                            var o = void 0;
                            document.createEvent ? (o = document.createEvent("Event")).initEvent("click", !0, !0) : o = new Event("click"),
                            r.dispatchEvent(o)
                        }
                    }
                } else
...
, function(e, t, n) {
    ...
    r.default.install("mobile", function() {
        ...
        e.config.enterBg && (e.config.enterBg.url ? d.style.backgroundImage = 'url("' + e.config.enterBg.url + '")' : e.config.enterBg.color && (d.style.background = e.config.enterBg.color)),
        e.start(),
        i ? (e.video.addEventListener("touchend", function(r) {
            r.preventDefault(),
...
, function(e, t, n) {
    ...
    r.default.install("logger", function() {
        var e = this
          , t = r.default.util;
        if (!0 !== e.config.noLog) {
            window.__xigua_log_sdk__ || (window.__xigua_log_sdk__ = new i.default("tracker"),
            ...
            "pc" === o.default.device ? window.addEventListener("beforeunload", s, !1) : "mobile" === o.default.device && window.addEventListener("pagehide", s, !1),
            e.on("routechange", s),
            e.on("destroy", function() {
                "pc" === o.default.device ? window.removeEventListener("beforeunload", s) : "mobile" === o.default.device && window.removeEventListener("pagehide", s)
            }),
            e.on("ended", function() {
                e.video.played;
            ...
            e.on("urlchange", function() {
                ...
                window.__xigua_log_sdk__("d", o)
            }),
            e.on("error", function(t) {
                e.video.played;
                var r = n(e.logParams.played);
                a();
                var o = (new Date).getTime();
                if (!(e.logParams.lastErrLog && o - e.logParams.lastErrLog <= 3e3)) {
                    e.logParams.lastErrLog = o;
                    var i = {
                        url: e.logParams.pluginSrc ? e.logParams.pluginSrc : e.logParams.playSrc,
                        vid: e.config.vid,
                        bc: e.logParams.bc - 1 > 0 ? e.logParams.bc - 1 : 0,
                        ...
                        vt: e.logParams.vt,
                        vd: 1e3 * e.logParams.vd,
                        watch_dur: parseFloat((1e3 * r).toFixed(3)),
                        err_msg: t.errd.msg,
                        line: t.errd.line,
                        et: o,
                        cur_play_pos: parseFloat((1e3 * e.currentTime).toFixed(3))
...
, function(e, t, n) {
    ...
    i.default.install("error", function() {
        ...
        e.on("error", function() {
            ...
            (o = n.querySelector(".xgplayer-error-refresh")) && ["touchend", "click"].forEach(function(t) {
...
, function(e, t, n) {
    ...
    void 0 === (i = "function" == typeof (r = function() {
        return function e(t, n, r) {
            var o, i, a = window, s = "application/octet-stream", l = r || s, u = t, c = !n && !r && u, d = document.createElement("a"), p = function(e) {
                return String(e)
            }, f = a.Blob || a.MozBlob || a.WebKitBlob || p, g = n || "download";
            if (f = f.call ? f.bind(a) : Blob,
            "true" === String(this) && (l = (u = [u, l])[0],
            u = u[1]),
            ...
            if (/^data:([\w+-]+\/[\w+.-]+)?[,;]/.test(u)) {
                if (!(u.length > 2096103.424 && f !== p))
                    return navigator.msSaveBlob ? navigator.msSaveBlob(b(u), g) : x(u);
                u = b(u),
                l = u.type || s
            } else if (/([\x80-\xff])/.test(u)) {
                for (var v = 0, y = new Uint8Array(u.length), m = y.length; v < m; ++v)
                    y[v] = u.charCodeAt(v);
                u = new f([y],{
                    type: l
                })
            ...
            function b(e) {
                for (var t = e.split(/[:;,]/), n = t[1], r = "base64" == t[2] ? atob : decodeURIComponent, o = r(t.pop()), i = o.length, a = 0, s = new Uint8Array(i); a < i; ++a)
                    s[a] = o.charCodeAt(a);
                return new f([s],{
                    type: n
                })
            ...
            if (o = u instanceof f ? u : new f([u],{
                type: l
            }),
            navigator.msSaveBlob)
                return navigator.msSaveBlob(o, g);
            if (a.URL)
                x(a.URL.createObjectURL(o), !0);
            else {
...
, function(e, t, n) {
    ...
    i.default.install("definition", function() {
        ...
        e.on("resourceReady", function(n) {
            ...
            e.on("canplay", function() {
                ...
                a.forEach(function(t) {
                    s.href = t.url,
                    e.dash ? n.push("<li url='" + t.url + "' cname='" + t.name + "' class='" + (t.selected ? "definition" : "") + "'>" + t.name + "</li>") : n.push("<li url='" + t.url + "' cname='" + t.name + "' class='" + (s.href === i ? "definition" : "") + "'>" + t.name + "</li>")
                });
                var l = a.filter(function(t) {
                    return s.href = t.url,
                    e.dash ? !0 === t.selected : s.href === i
                });
                n.push("</ul><p class='name'>" + (l[0] || {
                    name: ""
                }).name + "</p>");
                var u = o.querySelector(".xgplayer-definition");
                if (u) {
                    u.innerHTML = n.join("");
        ...
        ["touchend", "click"].forEach(function(o) {
            r.addEventListener(o, function(o) {
                ...
                if (i && "li" === i.tagName.toLocaleLowerCase()) {
                    if (e.emit("beforeDefinitionChange", s.href),
                    Array.prototype.forEach.call(i.parentNode.childNodes, function(e) {
                        t.removeClass(e, "definition")
                    }),
                    e.dash && a.forEach(function(e) {
                        e.selected = !1,
                        e.name === i.innerHTML && (e.selected = !0)
                    }),
                    t.addClass(i, "definition"),
                    i.parentNode.nextSibling.innerHTML = "" + i.getAttribute("cname"),
                    s.href = i.getAttribute("url"),
                    e.switchURL) {
                        var l = document.createElement("a");
                        ["mp4", "hls", "flv", "dash"].every(function(t) {
                            return !e[t] || (l = e[t].url,
                            !1)
                        }),
                        ...
                        var u = e.currentTime
                          , c = e.paused;
                        e.ended || (e.src = s.href,
                        e.once("canplay", function() {
                            e.currentTime = u,
                            c || e.play()
                        }))
                    }
                    e.emit("definitionChange", s.href),
                    "mobile" === n.device && t.removeClass(e.root, "xgplayer-definition-active")
                } else
                    "click" !== e.config.definitionActive || !i || "p" !== i.tagName.toLocaleLowerCase() && "em" !== i.tagName.toLocaleLowerCase() || (t.addClass(e.root, "xgplayer-definition-active"),
                    r.focus());
                e.emit("focus")
            }, !1)
        }),
    ...
    r.default.install("danmu", function() {
        ...
        if (e.config.danmu) {
            ...
            e.once("complete", function() {
                ...
                r.default.util.addClass(t, "xgplayer-has-bullet"),
                e.config.danmu.closeDefaultBtn || (e.bulletBtn = r.default.util.copyDom(i.bulletBtn.createSwitch(!0)),
                e.controls.appendChild(e.bulletBtn),
                ["click", "touchend"].forEach(function(n) {
                    e.bulletBtn.addEventListener(n, function(n) {
                        n.preventDefault(),
                        n.stopPropagation(),
                        r.default.util.toggleClass(e.bulletBtn, "danmu-switch-active"),
                        r.default.util.hasClass(e.bulletBtn, "danmu-switch-active") ? (r.default.util.addClass(t, "xgplayer-has-bullet"),
                        e.once("timeupdate", function() {
                            i.start()
                        })) : (r.default.util.removeClass(t, "xgplayer-has-bullet"),
                        i.stop())
                    }, !1)
                }),
                e.on("pause", function() {
                ...
                e.on("seeked", function() {
                    r.default.util.hasClass(e.bulletBtn, "danmu-switch-active") && (i.stop(),
                    i.start())
                })),
                e.danmu = i
            })
...
, function(e, t, n) {
    ...
    (function(e) {
        ...
        i = function() {
                        ...
                        value: function(e) {
                            ...
                            if (this.el && "start" !== this.status)
                                ...
                                "scroll" === this.mode) {
                                    ...
                                    var n = (t.el.getBoundingClientRect().right - e.left) / this.moveV;
                                    this.el.style.transition = "transform " + n + "s linear 0s",
                                    setTimeout(function() {
                                        t.el && (t.el.style.transform = "translateX(-" + (t.el.getBoundingClientRect().right - e.left) + "px) translateY(0px) translateZ(0px)",
                                        t.moveTime = (new Date).getTime(),
                                        t.moveMoreS = t.el.getBoundingClientRect().left - e.left,
                                        t.moveContainerWidth = e.width,
                                        t.removeTimer = setTimeout(o, 1e3 * n))
                                    }, 20)
                                } else {
                                    this.el.style.left = "50%",
                                    this.el.style.margin = "0 0 0 -" + this.width / 2 + "px",
                                    this.pastDuration || (this.pastDuration = 1);
                                    var r = this.duration >= this.pastDuration ? this.duration - this.pastDuration : 0;
                                    this.removeTimer = setTimeout(o, r),
                            ...
                            function o() {
                                if (t.el)
                                    if ("scroll" === t.mode) {
                                        ...
                                        n && n.right <= e.left + 100 ? (t.status = "end",
                                        t.remove()) : (t.pauseMove(e),
                                        t.startMove(e))
                                    } else
                                        t.status = "end",
                                        t.remove()
                    ...
                    return r(e, [{
                        ...
                        value: function() {
                            ...
                            (l = t.player ? e.data.filter(function(t) {
                                ...
                                (r = new i.default(t,n)).attach(),
                                s.addBullet(r).result ? (e.queue.push(r),
                                r.topInit()) : r.detach()
                            })
                        }
                    }]),
            ...
            , function(e, t, n) {
                ...
                var s = function() {
                    ...
                    return r(e, [{
                        ...
                        value: function() {
                            var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                            return this.switchBtn = o.default.createDom("dk-switch", '<span class="txt">弹</span>', {}, "danmu-switch " + (e ? "danmu-switch-active" : "")),
                            this.switchBtn
                        }
                    }]),
                    e
            ...
            , function(e, t, n) {
                var r, o, i, s, l, u, c, d = n(25), p = n(11), f = Function.prototype.apply, g = Function.prototype.call, h = Object.create, v = Object.defineProperty, y = Object.defineProperties, m = Object.prototype.hasOwnProperty, b = {
                    configurable: !0,
                    enumerable: !1,
                    writable: !0
                };
            ...
            , function(e, t, n) {
                ...
                var l = function() {
                    function e(t) {
                        ...
                        this.config = a.default.deepCopy({
                            overlap: !1,
                            area: {
                                start: 0,
                                end: 1
                        ...
                        a.default.addClass(this.container, "danmu"),
                        this.bulletBtn = new i.default(this),
